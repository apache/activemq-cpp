...
#ifndef _ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_UNIVERSAL_CONSUMERCONTROLMARSHALLER_H_
...
#endif /*_ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_UNIVERSAL_CONSUMERCONTROLMARSHALLER_H_*/
