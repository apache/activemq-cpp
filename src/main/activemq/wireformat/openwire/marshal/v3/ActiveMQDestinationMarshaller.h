...
#ifndef _ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_V3_ACTIVEMQDESTINATIONMARSHALLER_H_
...
#endif /*_ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_V3_ACTIVEMQDESTINATIONMARSHALLER_H_*/
