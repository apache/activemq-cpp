...
#ifndef _ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_V3_REMOVEINFOMARSHALLER_H_
#define _ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_V3_REMOVEINFOMARSHALLER_H_
...
#endif /*_ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_V3_REMOVEINFOMARSHALLER_H_*/
