...
#ifndef _ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_V4_DESTINATIONINFOMARSHALLER_H_
...
#endif /*_ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_V4_DESTINATIONINFOMARSHALLER_H_*/
