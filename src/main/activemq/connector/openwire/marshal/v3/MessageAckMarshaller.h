...
#ifndef _ACTIVEMQ_CONNECTOR_OPENWIRE_MARSAHAL_V3_MESSAGEACKMARSHALLER_H_
#define _ACTIVEMQ_CONNECTOR_OPENWIRE_MARSAHAL_V3_MESSAGEACKMARSHALLER_H_
...
#endif /*_ACTIVEMQ_CONNECTOR_OPENWIRE_MARSAHAL_V3_MESSAGEACKMARSHALLER_H_*/
