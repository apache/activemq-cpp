...
#include <activemq/connector/openwire/marshal/v3/ConsumerInfoMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v3::ConsumerInfoMarshallerTest );
