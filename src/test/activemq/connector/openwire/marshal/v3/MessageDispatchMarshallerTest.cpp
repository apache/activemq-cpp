...
#include <activemq/connector/openwire/marshal/v3/MessageDispatchMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v3::MessageDispatchMarshallerTest );
