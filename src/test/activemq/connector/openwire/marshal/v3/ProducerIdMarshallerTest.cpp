...
#include <activemq/connector/openwire/marshal/v3/ProducerIdMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v3::ProducerIdMarshallerTest );
