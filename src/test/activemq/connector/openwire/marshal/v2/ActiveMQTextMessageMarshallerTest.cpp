...
#include <activemq/connector/openwire/marshal/v2/ActiveMQTextMessageMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v2::ActiveMQTextMessageMarshallerTest );
