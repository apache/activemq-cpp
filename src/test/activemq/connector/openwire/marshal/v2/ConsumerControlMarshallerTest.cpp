...
#include <activemq/connector/openwire/marshal/v2/ConsumerControlMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v2::ConsumerControlMarshallerTest );
