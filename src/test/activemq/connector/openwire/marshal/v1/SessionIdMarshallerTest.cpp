...
#include <activemq/connector/openwire/marshal/v1/SessionIdMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v1::SessionIdMarshallerTest );
