...
#include <activemq/connector/openwire/marshal/v1/ReplayCommandMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v1::ReplayCommandMarshallerTest );
