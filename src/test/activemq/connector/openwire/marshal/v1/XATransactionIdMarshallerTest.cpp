...
#include <activemq/connector/openwire/marshal/v1/XATransactionIdMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v1::XATransactionIdMarshallerTest );
