...
#include <activemq/connector/openwire/marshal/v1/SessionInfoMarshallerTest.h>
...
CPPUNIT_TEST_SUITE_REGISTRATION( activemq::connector::openwire::marshal::v1::SessionInfoMarshallerTest );
