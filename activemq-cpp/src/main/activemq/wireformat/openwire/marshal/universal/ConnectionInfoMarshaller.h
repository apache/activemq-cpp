...
#ifndef _ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_UNIVERSAL_CONNECTIONINFOMARSHALLER_H_
...
#endif /*_ACTIVEMQ_WIREFORMAT_OPENWIRE_MARSAHAL_UNIVERSAL_CONNECTIONINFOMARSHALLER_H_*/
