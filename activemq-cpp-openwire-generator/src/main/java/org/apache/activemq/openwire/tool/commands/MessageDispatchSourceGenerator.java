...
public class MessageDispatchSourceGenerator extends CommandSourceGenerator {
    ...
    protected void generateAdditionalMethods( PrintWriter out ) {
        out.println("////////////////////////////////////////////////////////////////////////////////");
        out.println("void MessageDispatch::setRollbackCause(const decaf::lang::Exception& cause) {");
        out.println("    this->rollbackCause = cause;");
        out.println("}");
        out.println("");
        out.println("////////////////////////////////////////////////////////////////////////////////");
        out.println("decaf::lang::Exception MessageDispatch::getRollbackCause() const {");
